        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex-shrink-0 flex items-center">
            <Link href="/" className="flex items-center space-x-3 group">
              <div className="relative p-2 rounded-xl bg-gradient-to-br from-blue-500/10 to-teal-500/10 group-hover:from-blue-500/20 group-hover:to-teal-500/20 transition-all duration-300">
                <Image
                  src="/logo.svg"
              ...
              <div>
                <span className="text-2xl font-bold bg-gradient-to-r from-blue-600 via-blue-700 to-teal-600 bg-clip-text text-transparent group-hover:from-blue-500 group-hover:to-teal-500 transition-all duration-300">
                  MADHVI ENTERPRISES
                </span>
          ...
          <div className="md:hidden flex items-center space-x-4">
            <a
              href="tel:+919876543210"
              className="flex items-center bg-gradient-to-r from-blue-600 to-teal-600 text-white px-4 py-2 rounded-lg font-semibold text-sm hover:from-blue-700 hover:to-teal-700 transition-all duration-300 shadow-md"
            >
