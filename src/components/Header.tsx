...
const Header = () => {
  ...
  return (
    <header className="bg-gradient-to-r from-white/95 via-blue-50/90 to-purple-50/90 backdrop-blur-xl shadow-xl sticky top-0 z-50 border-b border-blue-200/30">
      ...
      <nav className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <div className="flex items-center space-x-1">
              {navigation.map((item) => (
                ...
                >
                  {item.name}
                  <span className="absolute bottom-1 left-1/2 w-0 h-0.5 bg-gradient-to-r from-blue-600 to-purple-600 transition-all duration-300 group-hover:w-3/4 group-hover:left-1/8 rounded-full"></span>
                </Link>
              ))}
            </div>
          ...
          <div className="md:hidden flex items-center space-x-4">
            ...
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-xl text-gray-700 hover:text-blue-600 hover:bg-gradient-to-br hover:from-blue-50 hover:to-purple-50 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 transition-all duration-300 border border-gray-200/50 hover:border-blue-300/50"
            >
              {isMenuOpen ? (
        ...
        <AnimatePresence>
          {isMenuOpen && (
            ...
            >
              <div className="px-2 pt-2 pb-6 space-y-2 bg-gradient-to-br from-white/95 to-blue-50/80 backdrop-blur-sm border-t border-blue-200/30 rounded-b-xl">
                {navigation.map((item, index) => (
                  ...
                  >
                    <Link
                      href={item.href}
                      className="block px-4 py-3 text-base font-semibold text-gray-700 hover:text-blue-600 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 rounded-xl transition-all duration-300 border border-transparent hover:border-blue-200/50"
